    ...
    findToken : async (req, res, next) => {
        ...
        try {
            ...
            const result = await connection.execute(
                ...
                Gsmagri.rfid_pkg.RFID_SLIP_Data(:P_Token_search_Text,:P_RFID_Slip_Details ,:P_Status_Cd,:P_Status_Message);
               
                END;`,
                {
                    P_Token_search_Text:  { val: 'result', dir: oracledb.BIND_IN ,val: id.id.toString()},
                    P_RFID_Slip_Details:{ type: oracledb.CURSOR, dir : oracledb.BIND_OUT },
            ...
            const resultSet1 = result.outBinds.P_RFID_Slip_Details;
            ...
            const TokenDetails=await self.parseObject(oraColumns,rows1);
            let { P_Status_Cd, P_Status_Message } = jsonObj;
            const response = { TokenDetails: TokenDetails, status: P_Status_Cd, P_Status_Message};
